...
public class DatabaseUtils {
    ...
    static {
        ...
        var time1 = LocalDateTime.of(2005, 4, 21, 1, 1);
        var time2 = LocalDateTime.of(2019, 10, 23, 14, 44);
        // 模拟2个教师
        Teacher teach1 = new Teacher(1, "杨淳", List.of(c1, c4), t3, time1);
        Teacher teach2 = new Teacher(2, "淳杨", List.of(c2, c3), t2, time2);
        teachers = new ArrayList<>(List.of(teach1, teach2));
    }
